...
public class DBAdapter {
	...
	public static final String[] HERO_KEYS = new String[] {KEY_ROWID, KEY_NAME};
	public static final String[] IMAGE_KEYS = new String[] {KEY_ROWID, IMAGE};	
	public static final String[] ABILITY_KEYS = new String[] {KEY_ROWID, KEY_NAME, KEY_HERO};
...
//		return db.insert(DATABASE_TABLE, null, initialValues);
	...
	public Cursor getAllHero() {
		String where = null;
		Cursor c = 	db.query(true, DATABASE_TABLE_HERO, HERO_KEYS, 
	...
	public Cursor getAllHeroImage() {
		String where = null;
		Cursor c = 	db.query(true, DATABASE_TABLE_HERO, IMAGE_KEYS, 
							where, null, null, null, null, null);
		if (c != null) {
			c.moveToFirst();
		}
	...
	public Cursor getAllRowsAbility() {
		String where = null;
		Cursor c = 	db.query(true, DATABASE_TABLE_ABILITY, ABILITY_KEYS, 
							where, null, null, null, null, null);
		if (c != null) {
			c.moveToFirst();
		}
	...
	public Cursor getAllRowsItem() {
		String where = null;
		Cursor c = 	db.query(true, DATABASE_TABLE_ITEM, ITEM_KEYS, 
							where, null, null, null, null, null);
		if (c != null) {
			c.moveToFirst();
		}
